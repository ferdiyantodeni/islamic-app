        ...
        <div className="flex w-full min-h-screen bg-slate-50/50">
            ...
            <div className="flex-1 overflow-auto">
                <div className="mx-auto pt-20 sm:pt-8 pb-16 px-6 sm:px-14">
                    <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-400 hover:text-emerald-600 
                        ...
                        <article className="space-y-5 sm:space-y-8">
                            <header className="space-y-4 sm:space-y-5">
                                <div className="flex items-center gap-2 flex-wrap">
                                    <span className="inline-flex items-center gap-1.5 text-[11px] font-medium tracking-wide text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-100">
                            ...
                            <div className="relative bg-linear-to-br from-emerald-50 to-teal-50/40 rounded-3xl p-7 sm:p-10 border border-emerald-100/80 overflow-hidden">
                            ...
                            {doa.tr && (
                                <div className="px-1">
                                    <p className="text-sm sm:text-base text-emerald-700/80 italic leading-relaxed font-medium">{doa.tr}</p>
                                </div>
                            )}
