        ...
        <form className="mx-auto" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="block w-full p-3 pl-9 text-xs sm:text-sm text-gray-900 border border-teal-100 rounded-lg placeholder:text-xs sm:placeholder:text-sm placeholder-gray-400 focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400 transition-all"
                />
            </div>
        </form>
    )
