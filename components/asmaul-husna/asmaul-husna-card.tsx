...
export default function AsmaulHusnaCard({ latin, arabic, id, eng }: AsmaulHusnaCardProps) {
    return (
        <div className="flex flex-col items-center justify-center rounded-xl px-5 py-9 border border-teal-100 hover:shadow-md hover:border-teal-300 group transition-all duration-300">
